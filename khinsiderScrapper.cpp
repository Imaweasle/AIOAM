...
int main (int argc, const char *argv[]) {
  ...
  for(int i = 1; i < argc; i++) {
    ...
    switch (str[0]){
      case '-':
        ...
        switch (str[1]){
          case 'h':
            std::cout << "This is a program to download music from khinsider though new websites may be added at some point.\n\
  ...
  std::string firstCommand = "curl " + baseAddress + " --output processingFile.html";
  ...
  while (getline (fs, line)) {
    ...
    case 1:
      ...
      break;
    case 2:
      std::string secondCommand = "curl " + suburl + " --output subProcessingFile.html";
        ...
        switch(substage){
          ...
          case 0:
             if(contains(subLine, "Song name: ")) {
              ...
              substage++;
              std::cout << "Passed substage 0 at line " << lineNum << " song name: " << name<< std::endl;
             }
            break;
          case 1:
      ...
      if(linkNum >= 0) {
        thirdCommand = "curl " + downloadLinks[linkNum] +" --output " + outputFolder + "'" + name + "." + form + "'";
      } else {
        thirdCommand = "curl " + downloadLinks[0] +" --output " + outputFolder + "'" + name + "." + "mp3" + "'";
      } 
